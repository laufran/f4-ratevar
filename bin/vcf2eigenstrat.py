#!/usr/bin/python
# from https://github.com/mathii/gdc/blob/master/vcf2eigenstrat.py
# modified by LEF, appending open2 function from https://github.com/mathii/gdc/blob/master/gdc.py so we don't need another file
